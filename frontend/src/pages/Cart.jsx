  ...
  return (
    <>
      <style>{`
        ...
        .cart-page {
          padding: 3rem; background: #FFF8F0;
        ...
        .cart-item {
          ...
          border: 1.5px solid #f5ece0; transition: all 0.2s;
        }
        ...
        .remove-btn {
          ...
          cursor: pointer; font-size: 1.1rem; padding: 0.3rem; transition: color 0.2s;
        }
        ...
        .summary-title {
          font-family: 'Playfair Display', serif;
          font-size: 1.3rem; font-weight: 700; color: #1C1C1C; margin-bottom: 1.5rem;
        }
        .summary-row {
          display: flex; justify-content: space-between;
          margin-bottom: 0.8rem; color: #999; font-size: 0.9rem; font-weight: 700;
        }
        ...
        .continue-link {
          ...
          color: #999; font-size: 0.85rem; font-weight: 700; text-decoration: none;
        }
        ...
        .login-note a { color: #E8441A; font-weight: 900; text-decoration: none; }
            ...
            <div className="summary-card">
              ...
              {!user && (
                <div className="login-note">
                  You need to <Link to="/login">login</Link> to checkout
                </div>
              )}
